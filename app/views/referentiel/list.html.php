...
<div class="container">
    ...
    <div class="search-section">
        ...
        <button class="btn btn-teal" onclick="window.location.href='?page=add-referentiel-to-promotion'">
    ...
    <div class="cards-container">
        ...
        <?php else: ?>
            <?php foreach ($referentiels as $ref): ?>
                <div class="card" onclick="window.location.href='?page=apprenants&referentiel=<?= htmlspecialchars($ref['id']) ?>';" style="cursor: pointer;">
